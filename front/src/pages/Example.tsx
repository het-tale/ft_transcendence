// import { CalendarIcon, ChartBarIcon, FolderIcon, HomeIcon, InboxIcon, UsersIcon } from '@heroicons/react/'

const navigation = [
  { name: 'Dashboard', icon: '', href: '#', current: true },
  { name: 'Team', icon: '', href: '#', count: 3, current: false },
  { name: 'Projects', icon: '', href: '#', count: 4, current: false },
  { name: 'Calendar', icon: '', href: '#', current: false },
  { name: 'Documents', icon: '', href: '#', count: 12, current: false },
  { name: 'Reports', icon: '', href: '#', current: false },
]
